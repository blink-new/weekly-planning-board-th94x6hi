...
// Function to generate sample tasks, now accepting generateId as an argument
export const generateInitialTasks = (generateId: () => string): Task[] => {
  ...
  const initialTasksWithRecurring: Task[] = [
    ...initialTasks,
  ...
  return initialTasksWithRecurring;
};
